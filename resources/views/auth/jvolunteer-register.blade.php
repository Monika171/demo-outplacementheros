...
@section('content')
    ...
    <div class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="text-center"><h1 class="text">Mentor(Job Support) Signup</h1></div>
        </div>

          <div class="col-md-9 col-lg-8 mb-5 center" style="color: black; font-size: 14px;">
          
            <form method="POST"  action="{{ route('jvol.register') }}"  class="p-5 bg-white">
                @csrf

                <input type="hidden" value="jvolunteer" name="user_type">
