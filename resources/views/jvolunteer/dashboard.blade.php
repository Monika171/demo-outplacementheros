...
<section class="ftco-section" style="background: rgba(3,2,32,0.9);">
	<div class="container">
		...
		<div class="row">
            ...
            <form class="mb-2" action="{{route('jvseeker.index')}}" method="GET">
                ...
                <div class="col-md-12 mb-4 ftco-animate text-center">
                  <a href="{{route('jvseeker.index')}}"><i class="fa fa-undo text-info" aria-hidden="true" style="font-size: 38px;"></i></a>
                </div>
          ...
          <div class="col-md-12 ftco-animate">
					...
					<div class="job-post-item bg-white p-2 d-block d-md-flex align-items-center">
                            ...
                            <div class="col-4 col-md-3 text-center">
                                <a href="{{route('jvseeker.show',[$seeker->user_id])}}"> 
                                <div class="d-flex">                                                               
