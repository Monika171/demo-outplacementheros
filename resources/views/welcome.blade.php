            ...
            <div class="rounded border jobs-wrap">
              ...
              <a href="{{route('jobs.show',[$job->id,$job->slug])}}" class="job-item d-block d-md-flex align-items-center  border-bottom @if($job->type=='parttime') partime @elseif($job->type=='fulltime')fulltime @else freelance   @endif;">
                <div class="company-logo blank-logo text-center text-md-left pl-3">
                  ...
                  @else
              <img src="{{asset('profile_pic/man.jpg')}}" alt="Image" class="img-fluid mx-auto">
                  @endif
                </div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 text-center" data-aos="fade">
            <h1 class="h3 mb-0">We Are Here For You</h1>
            <p class="h3 text-white mb-5">Join Us...</p>
      ...
      <div class="container">
        ...
        <div class="d-block d-md-flex border-bottom">
          ...
          <div class="text-center p-4 item" data-aos="fade">
            ...
            <h2 class="h4">Simple Registration Process</h2>
            <p>Insert Description here</p>
            <p><a href="#">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
        <div class="d-block d-md-flex">
          <div class="text-center p-4 item border-right" data-aos="fade">
            ...
            <h2 class="h4">Candidates are Registered before lay off</h2>
            <p>Insert Description here</p>
            <p><a href="#">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
          <div class="text-center p-4 item" data-aos="fade">
            <span class="flaticon-calculator display-3 mb-3 d-block text-primary"></span>
            <h2 class="h4">NO Fee! FREE For All!!</h2>
            <p>Insert Description here</p>
            <p><a href="#">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
